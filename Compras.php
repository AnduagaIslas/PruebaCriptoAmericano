...
<div class="row margenes secciones">
  <div class="col-md-3">
    <div class="list-group">
      ...
      <button type="button" class="list-group-item list-group-item-action">CATEGORIAS</button>
      <button type="button" class="list-group-item
       list-group-item-action">Bitcoin</button>
      <button type="button" class="list-group-item list-group-item-action">Ethereum</button>
      <button type="button" class="list-group-item list-group-item-action">Dogecoin</button>
      <button type="button" class="list-group-item list-group-item-action" disabled>Trending</button>
    </div>
  </div>
  <div class="col-md-8">
    <div class="container">
